        ...
        <div className='add-list flex-col'>
            ...
            <form className='form flex-col' onSubmit={handleSubmit}>
                <div className="input-wrapper">
                    <input type="text" name="name" id="todo-list-name" placeholder='Ponle un nombre' value={data.name} onChange={handleChange} className="form__name" />
                    <label htmlFor="">
                        Name
                    </label>
                </div>
